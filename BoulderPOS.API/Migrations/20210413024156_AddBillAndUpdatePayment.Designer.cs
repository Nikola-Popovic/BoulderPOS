...
namespace BoulderPOS.API.Migrations
{
    ...
    [Migration("20210413024156_AddBillAndUpdatePayment")]
    partial class AddBillAndUpdatePayment
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BoulderPOS.API.Models.Bill", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.HasIndex("CustomerId")
                        .HasDatabaseName("iX_bills_customerId");

                    b.ToTable("bills");
                });

            modelBuilder.Entity("BoulderPOS.API.Models.BillProduct", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pK_billProducts");

                    b.HasIndex("BillId")
                        .HasDatabaseName("iX_billProducts_billId");

                    b.HasIndex("CustomerId")
                        .HasDatabaseName("iX_billProducts_customerId");

                    b.HasIndex("ProductId")
                        .HasDatabaseName("iX_billProducts_productId");
            ...
            modelBuilder.Entity("BoulderPOS.API.Models.Bill", b =>
                {
                    b.HasOne("BoulderPOS.API.Models.Customer", "Customer")
                        ...
                        .HasConstraintName("fK_bills_customers_customerId");
            ...
            modelBuilder.Entity("BoulderPOS.API.Models.BillProduct", b =>
                {
                    b.HasOne("BoulderPOS.API.Models.Bill", null)
                        .WithMany("Products")
                        .HasForeignKey("BillId")
                        .HasConstraintName("fK_billProducts_bills_billId");

                    b.HasOne("BoulderPOS.API.Models.Customer", "Customer")
                        .WithMany("BillProducts")
                        .HasForeignKey("CustomerId")
                        .HasConstraintName("fK_billProducts_customers_customerId");

                    b.HasOne("BoulderPOS.API.Models.Product", "Product")
                        .WithMany("Orders")
                        .HasForeignKey("ProductId")
                        .HasConstraintName("fK_billProducts_products_productId")
